...
.m-colorPicker ul,li,ol{ list-style: none; margin: 0; padding: 0; }
.m-colorPicker input{ display: none; }
.m-colorPicker .colorBtn{ width: 30px; height: 30px; }
...
.hd  .colorView{ width: 100px; height: 30px; float: left; transition: background-color .3s ease; }
.hd  .defaultColor{ width: 80px; float: right; text-align: center; border: 1px solid #ddd; cursor: pointer; }
  .tColor li{ width: 15px; height: 15px; display: inline-block; margin: 0 2px; transition: all .3s ease; }


.tColor li:hover{ box-shadow: 0 0 5px rgba(0,0,0,.4); transform: scale(1.3); }
.bColor >li{width: 15px; display: inline-block; margin: 0 2px;}
    .bColor>li >li{
        display: block; width: 15px; height: 15px; transition: all .3s ease; margin: 0;
    }
    .bColor li:hover{
